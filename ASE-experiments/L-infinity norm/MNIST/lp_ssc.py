"""
Sign-Sign Cover of MNIST based on L-infinity Norm
...
def SSCover(model, activations, nc_layer, nc_index, im):
    var_names_vect = ['d']
    objective = [1]
    ...
    # target_sp=np.unravel_index(nc_index, nc_layer.cover_map.shape)
    decision_index = nc_layer.the_feature_index
    decision_pos = np.unravel_index(decision_index, var_names[target_index + 1].shape)
    cond_pos = np.unravel_index(nc_index, var_names[target_index - 1].shape)
                    ...
                    for K in range(0, osp[2]):
                        for L in range(0, osp[3]):
                            if l == target_index and not (
                                    I == decision_pos[0] and J == decision_pos[1] and K == decision_pos[2] and L ==
                                    decision_pos[3]):
                                continue
                            else:
                                constraint = [[], []]
                                ...
                                if (l == target_index and (
                                        I == decision_pos[0] and J == decision_pos[1] and K == decision_pos[2] and L ==
                                        decision_pos[3])) or (l == target_index - 2 and (
                                        I == 0 and J == cond_pos[1] and K == cond_pos[2] and L == cond_pos[3])):
                    ...
                    for J in range(0, osp[2]):
                        for K in range(0, osp[3]):
                            ...
                            if activations[l][0][I][J][K] == 0:
                                if l == target_index - 1 and I == 0 and J == cond_pos[1] and K == cond_pos[2] and L == \
                                        cond_pos[3]:
