...
def run_concolic_bc(model):
    ...
    while True:
        ...
        # print 'hk shape', bc_layer.hk.shape
        bc_v = bc_layer.hk[pos[1]][pos[2]][pos[3]][pos[4]]
        if not bc_udi: bc_v = bc_layer.lk[pos[1]][pos[2]][pos[3]][pos[4]]
        feasible, d, new_im = boundary_cover(model, activations, bc_layer, bc_index_, im, bc_udi, bc_v, layer_functions)
        ###
