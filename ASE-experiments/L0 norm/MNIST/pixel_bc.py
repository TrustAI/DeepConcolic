...
def influential_pixel_manipulation(image, neural_network, max_index, pixel_num, ii, jj, kk, l, bc_udi, bc_v,
                                   layer_functions):
    ...
    if bc_udi:
        ...
        activations[l] = bc_v - activations[l]
...
def accumulated_pixel_manipulation(image, neural_network, sorted_feature_map, mani_range, label, ii, jj, kk, l, bc_udi,
                                   bc_v, layer_functions):
...
# manipulate row*col pixels (:, :) at each time
def influential_pixel_manipulation_dense(image, neural_network, max_index, pixel_num, hh, l, bc_udi, bc_v,
                                         layer_functions):
    # print('\nGetting influential pixel manipulations: ')
...
def accumulated_pixel_manipulation_dense(image, neural_network, sorted_feature_map, mani_range, label, hh, l, bc_udi,
                                         bc_v, layer_functions):
    # print('\nLooking for adversary images...')
    # print('Manipulation range: ', mani_range)
