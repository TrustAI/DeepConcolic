...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='Fashion-MNIST', help='Fashion-MNIST')
    ...
    parser.add_argument('--model', type=str, default='modelA', help='modelA')
    ...
    trainset = torchvision.datasets.FashionMNIST(root='./fashion-data', train=True, download=True, transform=transforms_normalize)
    train_loader = torch.utils.data.DataLoader(trainset, batch_size=args.batch_size, shuffle=True, num_workers=2)

    testset = torchvision.datasets.FashionMNIST(root='./fashion-data', train=False, download=True, transform=transforms_normalize)
