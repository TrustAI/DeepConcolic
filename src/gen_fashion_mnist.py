...
def make_medium_maxp_model (input_shape, **kwds):
    return tf.keras.models.Sequential([
        tf.keras.layers.Conv2D(64, (3, 3), kernel_initializer = 'he_uniform', input_shape = input_shape),
        tf.keras.layers.Activation('relu'),
        tf.keras.layers.MaxPooling2D((2, 2)),
        tf.keras.layers.Conv2D(32, (5, 5), kernel_initializer = 'he_uniform'),
        tf.keras.layers.Activation('relu'),
        tf.keras.layers.MaxPooling2D((2, 2)),
        tf.keras.layers.Flatten(),
        tf.keras.layers.Dense(100, kernel_initializer = 'he_uniform'),
        tf.keras.layers.Activation('relu'),
        # tf.keras.layers.Conv2D(24, (5, 5), input_shape = input_shape),
        # tf.keras.layers.Activation('relu'),
