...
def train_n_save_classifier (model, class_names,
...
def classifier (load_data, make_model, model_name = None, **kwds):
    train_data, test_data, input_shape, class_names = load_data ()
    model = make_model (input_shape, name = model_name)
    train_n_save_classifier (model, class_names, train_data, test_data, **kwds)
